...
DATA_PATH = Path("data/samples_r_thumb.csv")
MODELS_DIR = Path("models")
MODELS_DIR.mkdir(parents=True, exist_ok=True)
MODEL_PATH = MODELS_DIR / "r_thumb_svm.joblib"
CLASSES_PATH = MODELS_DIR / "r_thumb_classes.json"
METRICS_PATH = MODELS_DIR / "r_thumb_metrics.txt"


def load_csv(path: Path):
    assert path.exists(), f"Dataset not found at {path}. Run collect_data_mini.py --feature thumb first."
